...
func (game *Game) InitWindows() {
	game.WindowCharaDesigner = game.newWindow(480, 720, "Character Designer")
	{
		...
		skin.Add(gui.NewLabel("Dark ↔ Light"))
		sDarkLight := gui.NewHSlider(400, 20)
		sDarkLight.SetText("Label")
		sDarkLight.SetValue(0.75)
		skin.Add(sDarkLight)
		skin.Add(gui.NewLabel("Adjust Hue"))
		sHue := gui.NewHSlider(400, 20)
		sHue.SetValue(0.5)
		skin.Add(sHue)
		skin.Add(gui.NewLabel("Adjust Saturation"))
		sSaturation := gui.NewHSlider(400, 20)
		sSaturation.SetValue(0.5)
		skin.Add(sSaturation)
		skin.Add(gui.NewLabel("Adjust Value"))
		sValue := gui.NewHSlider(400, 20)
		sValue.SetValue(0.5)
		skin.Add(sValue)
